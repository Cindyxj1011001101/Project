...
public class PushAgentEscape2 : Agent
{
    // 拾取到的钥匙对象，在拾取后激活显示。
    ...
    private DungeonEscapeEnvController2 m_GameController;

    // 初始化方法，在游戏开始时调用一次。
    public override void Initialize()
    {
        // 获取父物体上的环境控制器组件。
        m_GameController = GetComponentInParent<DungeonEscapeEnvController2>();
